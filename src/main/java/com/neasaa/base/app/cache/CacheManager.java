...
public class CacheManager {
  ...
  @Setter private OperationEntityDao operationEntityDao;

  @Setter private AppRoleDao appRoleDao;
  ...
  public void loadCache() throws SQLException {
    ...
    //			singleConfigs.put(config.getConfigGroup().toUpperCase() + "-" +
    // config.getConfigName().toUpperCase(), config.getConfigValue());
    //		}
