...
@Scope("prototype")
public class GetSessionDetailOperation
    extends AbstractOperation<EmptyOperationRequest, GetSessionDetailResponse> {
  ...
  @Override
  public GetSessionDetailResponse doExecute(EmptyOperationRequest opRequest)
