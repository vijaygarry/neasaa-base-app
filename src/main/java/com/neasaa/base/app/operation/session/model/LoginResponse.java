...
public class LoginResponse extends OperationResponse {
  ...
  @JsonIgnore private long sessionId;
  @JsonIgnore private boolean sessionActive;
  @JsonIgnore private boolean authenticated;
  @JsonIgnore private Date sessionCreationTime;
  private Date lastAccessTime;

  @Setter @JsonIgnore private AppSessionUser appSessionUser;
}
