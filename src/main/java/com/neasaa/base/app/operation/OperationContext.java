...
public class OperationContext {
  ...
  public OperationContext(AppSessionUser appSessionUser, String appHostName) {
    ...
    this.auditInfo =
        AuditInfo.builder()
            ...
            .lastUpdatedBy(
                appSessionUser == null ? NOT_LOGGED_IN_USER_ID : appSessionUser.getUserId())
  ...
  public static class ClientInformation {
    ...
    private final String
        operatingSystem; // e.g. Windows NT 10.0, Mac OS X 10_15_7, Android 13, iOS 16
