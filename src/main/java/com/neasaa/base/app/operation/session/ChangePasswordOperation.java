...
public class ChangePasswordOperation
    extends AbstractOperation<ChangePasswordRequest, EmptyOperationResponse> {
  ...
  @Override
  public EmptyOperationResponse doExecute(ChangePasswordRequest opRequest)
    ...
    authenticationService.changePassword(
        appSessionUser.getLogonName(),
        opRequest.getCurrentPassword(),
        opRequest.getNewPassword(),
