...
public class OperationFactory implements ApplicationContextAware {
  ...
  /**
   * @param aClazz - Interface class instance
   * @return
   * @throws OperationException
   */
  public static <OP extends Operation<?, ?>> OP getOperationByType(Class<OP> aClazz)
      throws OperationException {
    try {
      ...
      throw new InternalServerException(
          "Internal error while executing your operation. Please contact administrator.");
    }
  }
