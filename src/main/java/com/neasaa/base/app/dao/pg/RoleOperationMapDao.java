...
public class RoleOperationMapDao extends AbstractDao {
  ...
  private PreparedStatement buildInsertStatement(
      Connection aConection, RoleOperationMap aRoleOperationMap) throws SQLException {
    String sqlStatement =
        "INSERT INTO LKPROLEOPERATIONMAP (ROLEID, OPERATIONID, CREATEDBY, CREATEDDATE, LASTUPDATEDBY, LASTUPDATEDDATE) VALUES (?, ?, ?, ?, ?, ?)";
            ...
            new PreparedStatementCreator() {
              ...
              public PreparedStatement createPreparedStatement(Connection aConection)
                ...
                String deleteSqlQuery =
                    "DELETE FROM LKPROLEOPERATIONMAP WHERE ROLEID = ? and OPERATIONID = ?";
  ...
  public PreparedStatement buildUpdateStatement(
    ...
    String updateStatement =
        "UPDATE LKPROLEOPERATIONMAP SET CREATEDBY = ? , CREATEDDATE = ? , LASTUPDATEDBY = ? , LASTUPDATEDDATE = ?  where ROLEID = ? and OPERATIONID = ?";
  ...
  public RoleOperationMap fetchRoleOperationMap(RoleOperationMap aRoleOperationMap)
      throws SQLException {
    String selectQuery =
        "select  ROLEID , OPERATIONID , CREATEDBY , CREATEDDATE , LASTUPDATEDBY , LASTUPDATEDDATE  from LKPROLEOPERATIONMAP where ROLEID = ?  and OPERATIONID = ? ";
    return getJdbcTemplate()
        .queryForObject(
            selectQuery,
            new RoleOperationMapRowMapper(),
            aRoleOperationMap.getRoleId(),
            aRoleOperationMap.getOperationId());
  }
}
