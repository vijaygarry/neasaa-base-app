...
public class OtpVerificationHistoryRowMapper implements RowMapper<OtpVerificationHistory> {
	...
	public OtpVerificationHistory mapRow(ResultSet aRs, int aRowNum) throws SQLException {
		...
		otpVerificationHistory.setLastAttemptDate(AbstractDao.getTimestampFromResultSet(aRs, "LASTATTEMPTDATE"));
		otpVerificationHistory.setCreatedDate(AbstractDao.getTimestampFromResultSet(aRs, "CREATEDDATE"));
		otpVerificationHistory.setLastUpdatedDate(AbstractDao.getTimestampFromResultSet(aRs, "LASTUPDATEDDATE"));
