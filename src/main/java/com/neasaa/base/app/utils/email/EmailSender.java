...
public class EmailSender {
  ...
  public void sendEmail(EmailMessage emailMessage) {
    ...
    try {
      ...
      if (emailMessage.getFromDisplayName() == null
          || emailMessage.getFromDisplayName().isEmpty()) {
        helper.setFrom(emailMessage.getFrom());
      } else {
        helper.setFrom(
            new InternetAddress(emailMessage.getFrom(), emailMessage.getFromDisplayName()));
      }
